      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="bg-soft-black p-8 rounded-xl border border-purple-medium/50 shadow-lg flex flex-col">
            <h3 className="text-2xl font-bold font-headline mb-4 text-lavender-light">
            ...
            <a href="#" className="mt-4 font-bold text-lavender-light hover:text-white transition-colors">
              Saber más →
            </a>
          </div>
