    ...
    <footer className="bg-soft-black text-off-white/70 pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <h4 className="font-bold font-headline text-lg mb-4 text-white">RestroWizard</h4>
            <ul>
              <li className="mb-2">
          ...
          <div>
            <h4 className="font-bold font-headline text-lg mb-4 text-white">Ecosistema</h4>
            <ul>
              <li className="mb-2">
                <a href="#" className="hover:text-white transition-colors">RestroTalent</a>
              </li>
              <li className="mb-2">
                <a href="#" className="hover:text-white transition-colors">RestroLearn</a>
              </li>
              <li className="mb-2">
                <a href="#" className="hover:text-white transition-colors">RestroServices</a>
              </li>
            </ul>
          </div>
          
          <div>
            <h4 className="font-bold font-headline text-lg mb-4 text-white">Recursos</h4>
            <ul>
              <li className="mb-2">
          ...
          <div>
            <h4 className="font-bold font-headline text-lg mb-4 text-white">Legal</h4>
            <ul>
              <li className="mb-2">
